...
module PingPong_Buffer (
    ...
    // 2-stage synchronizer for 3 banks
    logic write_done_0;
    ...
    always_comb begin
        ...
        case (w_state)
            W_BUFFER_0: begin
                write_done_2 = 1; // Bank 0에 쓰고 있다는 것은 Bank 2가 가장 최신 완성본이라는 뜻
                we_0 = we;
                wAddr_0 = wAddr;
                wData_0 = wData;
            ...
            W_BUFFER_1: begin
                write_done_0 = 1; // Bank 1에 쓰고 있다는 것은 Bank 0이 가장 최신 완성본이라는 뜻
                we_1 = we;
                wAddr_1 = wAddr;
                wData_1 = wData;
                if (wAddr == 320 * 240 - 1) begin
            ...
            W_BUFFER_2: begin
                write_done_1 = 1; // Bank 2에 쓰고 있다는 것은 Bank 1이 가장 최신 완성본이라는 뜻
                we_2 = we;
                wAddr_2 = wAddr;
                wData_2 = wData;
                if (wAddr == 320 * 240 - 1) begin
    ...
    always_comb begin
        ...
        case (r_state)
            R_BUFFER_0: begin
                ...
                // 화면의 마지막 픽셀을 그릴 때(rAddr == 320*240-1)만 뱅크 전환 허용
...
//     state_t w_state, w_state_next;
//     state_t r_state, r_state_next;
...
//     logic we_0, we_1;
//     logic [16:0] wAddr_0, wAddr_1;
//     logic [16:0] rAddr_0, rAddr_1;
//     logic [7:0] wData_0, wData_1;
//     logic [7:0] rData_0, rData_1;

//     // 2-stage synchronizer
//     logic write_done_0;
//     logic write_done_meta_0;
//     logic write_done_sync_0;
//     logic write_done_1;
//     logic write_done_meta_1;
//     logic write_done_sync_1;
