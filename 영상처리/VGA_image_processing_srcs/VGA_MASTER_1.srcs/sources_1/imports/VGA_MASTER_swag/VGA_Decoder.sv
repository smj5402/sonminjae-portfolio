...
module vga_decoder (
    ...
    assign h_sync = !((h_count >= (H_Front_porch + H_Visible_area)) && 
                      (h_count  < (H_Front_porch + H_Visible_area + H_Sync_pulse)));
    assign v_sync = !((v_count >= (V_Front_porch + V_Visible_area)) && 
                      (v_count  < (V_Front_porch + V_Visible_area + V_Sync_pulse)));
