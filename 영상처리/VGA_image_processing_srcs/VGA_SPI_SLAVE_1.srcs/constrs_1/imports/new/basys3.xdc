...
set_property -dict { PACKAGE_PIN H1   IOSTANDARD LVCMOS33 } [get_ports vsync_in];#Sch name = JA7
set_property -dict { PACKAGE_PIN K2   IOSTANDARD LVCMOS33 } [get_ports uart_rx];#Sch name = JA8
